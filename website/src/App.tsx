...
function App() {
  ...
  const fallbackDownloadUrl = 'https://github.com/NgocThachTN/RockyDexMobile/releases/download/v1.3.0/rockydex-v1.3.0.apk';
        ...
        <main className="right-panel">
          ...
          <section className="card">
            ...
            {isLoading ? (
              ...
              <div>
                <div className="changelog-meta">
                  <span>Tên file: rockydex-v1.3.0.apk</span>
                  <span>Dung lượng: 54.3 MB</span>
                </div>
                <p style={{ marginBottom: '8px' }}>Không thể tải nhật ký cập nhật trực tiếp. Dưới đây là các thay đổi chính trong v1.3.0:</p>
                <li style={{ marginLeft: '16px', marginBottom: '6px', listStyleType: 'square' }}>Tối ưu bottom sheet chọn chương trong trình đọc để mở và cuộn mượt hơn.</li>
                <li style={{ marginLeft: '16px', marginBottom: '6px', listStyleType: 'square' }}>Giảm rebuild khi chỉnh độ sáng và cấu hình trình đọc.</li>
                <li style={{ marginLeft: '16px', marginBottom: '6px', listStyleType: 'square' }}>Cập nhật thông tin phiên bản cho Splash, Profile và luồng OTA qua GitHub Releases.</li>
              </div>
            )}
          </section>
        </main>
