...
function App() {
  ...
  const fallbackVersion = 'v1.0.12';
  const fallbackDownloadUrl = 'https://github.com/NgocThachTN/RockyDexMobile/releases/download/v1.0.12/rockydex-v1.0.12.apk';
        ...
        <main className="right-panel">
          ...
          <section className="card">
            ...
            {isLoading ? (
              ...
              <div>
                <div className="changelog-meta">
                  <span>Tên file: rockydex-v1.0.12.apk</span>
                  <span>Dung lượng: 54.3 MB</span>
                </div>
                <p style={{ marginBottom: '8px' }}>Không thể tải nhật ký cập nhật trực tiếp. Dưới đây là các thay đổi chính trong v1.0.12:</p>
